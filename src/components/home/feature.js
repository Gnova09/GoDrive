    ...
    <div className=" border rounded bg-blue-100 m-4 px-4 py-8">
      ...
      <div className="grid grid-cols-3 gap-6 text-center">
        ...
        <div className="flex flex-col items-center">
          <img src="/public/assets/carsImgenes/Seguridad.webp" alt="Seguridad" className="w-12 h-12 mb-2"/>
        ...
        {/* Segundo ítem */}
        <div className="flex flex-col items-center">
          <img src="/public/assets/carsImgenes/Proteccion.webp" alt="Protección" className="w-12 h-12 mb-2" />
        ...
        {/* Tercer ítem */}
        <div className="flex flex-col items-center">
          <img src="/public/assets/carsImgenes/Rapidez.webp" alt="Rapidez" className="w-12 h-12 mb-2" />
        ...
        {/* Cuarto ítem */}
        <div className="flex flex-col items-center">
          <img src="/public/assets/carsImgenes/Flexibilidad.webp" alt="Flexibilidad" className="w-12 h-12 mb-2" />
        ...
        {/* Quinto ítem */}
        <div className="flex flex-col items-center">
          <img src="/public/assets/carsImgenes/Comodidad.webp" alt="Comodidad" className="w-12 h-12 mb-2" />
        ...
        {/* Sexto ítem */}
        <div className="flex flex-col items-center">
          <img src="/public/assets/carsImgenes/Multimonedas.webp" alt="Multimonedas" className="w-12 h-12 mb-2" />
